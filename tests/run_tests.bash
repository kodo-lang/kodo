...
run_test "compile-error/bad_mutability.kd" 1 "error: attempted assignment of immutable variable 'foo' on line 7
...
run_test "success/instance_member_function.kd" 10 ""
